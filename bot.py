...
# ============================================================
# NEW: MACROECONOMIC SENTIMENT & NEWS FILTER MODULE
# ============================================================
    ...
    def _fetch_macro_data(self):
        try:
            ...
            with self.lock:
                ...
                if dxy_data and dxy_data.get('price'):
                    self._update_dxy_trend(dxy_data['price'])
                    
                self._update_gold_bias()
                
            logger.debug(f"📊 Macro data updated: DXY=${dxy_data.get('price', 0) if dxy_data else 0}")
