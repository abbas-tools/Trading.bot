...
# REMOVED MAX_POSITION_SIZE - now using 30% portfolio
...
def calculate_smart_position_size(capital, kelly_fraction, atr, current_price, confidence_score=1.0):
    ...
    try:
        ...
        # ============================================================
        # PORTFOLIO 30% POSITION SIZING - FIXED!
        # ============================================================
    ...
    try:
        ...
        for symbol in trading_symbols[:10]:
            ...
            try:
                ...
                # Calculate position size - NOW USING 30% PORTFOLIO
...
logger.info("✅ Starting Quantum Whale Terminal v8.0...")
logger.info(f"📊 Mode: {TRADING_MODE}")
