...
try:
    ...
    logger.warning("⚠️ Using threading mode")
...
# ============================================================
# PRODUCTION - Start bot thread when app loads
# ============================================================

# Start bot thread automatically when app starts (for Gunicorn)
bot_thread = threading.Thread(target=run_bot, daemon=True)
bot_thread.start()
logger.info("✅ Bot started automatically!")

# ============================================================
# MAIN - Only runs when executed directly (not with Gunicorn)
# ============================================================
...
if __name__ == '__main__':
    ...
    # Only run socketio.run() if running directly (not with Gunicorn)
    # When Gunicorn runs, it uses the 'app' object directly
    try:
        import eventlet
        eventlet.monkey_patch()
